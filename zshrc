...
alias pnv="~/.local/bin/push-no-verify.sh"
alias mdev="~/.local/bin/merge-to-dev.sh"
alias pmain="~/.local/bin/pull-main.sh"
...
export PATH="$PATH:/Users/antonio/.lmstudio/bin"
...
alias claude-mem='/Users/antonio/.bun/bin/bun "/Users/antonio/.claude/plugins/marketplaces/thedotmack/plugin/scripts/worker-service.cjs"'
...
# Machine-local secrets & overrides (NOT committed) — ver ~/.zshrc.local
